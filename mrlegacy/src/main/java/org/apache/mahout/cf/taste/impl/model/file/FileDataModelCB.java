 ...
 * {@link FileDataModelCB} without re-copying the entire data file.
 * </p>
 *
 * <p>
...
public class FileDataModelCB extends AbstractDataModel {
  ...
  public FileDataModelCB(File dataFile) throws IOException {
	    this(dataFile, false, DEFAULT_MIN_RELOAD_INTERVAL_MS, false);
	  }
  /**
   * @param dataFile
   ...
   */
  public FileDataModelCB(File dataFile, boolean usePrefs) throws IOException {
    this(dataFile, false, DEFAULT_MIN_RELOAD_INTERVAL_MS, usePrefs);
  }
   ...
   */
  public FileDataModelCB(File dataFile, String delimiterRegex, boolean usePrefs) throws IOException {
    this(dataFile, false, DEFAULT_MIN_RELOAD_INTERVAL_MS, delimiterRegex, usePrefs);
  }
   ...
   */
  public FileDataModelCB(File dataFile, boolean transpose, long minReloadIntervalMS, boolean usePrefs) throws IOException {
    this(dataFile, transpose, minReloadIntervalMS, null, usePrefs);
  }
   ...
   * @throws IOException
   */
  public FileDataModelCB(File dataFile, boolean transpose, long minReloadIntervalMS, String delimiterRegex, boolean usePrefs)
    throws IOException {
    ...
    hasPrefValues = firstLineSplit.size() >= 3 && !firstLineSplit.get(2).isEmpty() && usePrefs ;
  ...
  /**
   * Note that this method only updates the in-memory preference data that this {@link FileDataModelCB}
